...
namespace Infrastructure.Helpers
{
    public class MovieShopMappingProfile : Profile
    {
        public MovieShopMappingProfile()
        {
            ...
            CreateMap<Movie, BasicMovieResponseModel>();
            CreateMap<Role, RoleModel>();
            CreateMap<Genre, GenreModel>().ReverseMap();
            CreateMap<PurchaseRequestModel, Purchase>();
            CreateMap<Purchase, BasicMovieResponseModel>().ForMember(p => p.Id, opt => opt.MapFrom(src => src.Movie.Id))
        ...
        private static List<BasicCastModel> GetCasts(IEnumerable<MovieCast> srcMovieCasts)
        {
            var movieCast = new List<BasicCastModel>();
            foreach (var cast in srcMovieCasts)
                movieCast.Add(new BasicCastModel
                {
                    Id = cast.CastId,
